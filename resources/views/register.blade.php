          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <div class="row">
                  <div class="col-2">
                    <img src="{{ asset('assets/img/logo/logo.png') }}" alt="Logo" width="30px">
                  </div>
                  <div class="col-2">
                    <a href="index.html" class="app-brand-link">
                      <span class="app-brand-text demo text-dark fw-bolder ">Kaha Visual</span>
                    </a>
                  </div>
                </div>
              </div>
              ...
              <form method="POST" action="{{ route('proses.register') }}">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" placeholder="Telepon" id="telepon" class="form-control form-control-lg" name="telepon" required>
